...
class penyakit_search : Fragment() {

    var view1: View? = null
    var keyword_penyakit: String? = null
    ...
    override fun onCreateView(
        ...
        view1 = inflater.inflate(R.layout.fragment_penyakit_search, container, false)

        val b = this.arguments
        keyword_penyakit = b!!.getString("keywordpenyakit")
        ...
        loaddatasearchpenyakit()

        return view1
    }

    companion object {
        fun newInstance(): penyakit_search {
            return penyakit_search()
        }
    }

    fun loaddatasearchpenyakit() { RequestAsyncPenyakitSearch().execute() }

    inner class RequestAsyncPenyakitSearch: AsyncTask<String?, String?, String?>() {
        ...
        override fun doInBackground(vararg strings: String?): String? {
            return try {
                ...
                postDataParams.put("keyword", keyword_penyakit)
                postDataParams.put("method", "SearchPenyakit")

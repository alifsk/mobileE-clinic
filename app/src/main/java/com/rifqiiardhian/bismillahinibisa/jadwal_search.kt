...
class jadwal_search : Fragment() {
    ...
    override fun onCreateView(
        ...
        view1 = inflater.inflate(R.layout.fragment_jadwal_search, container, false)
    ...
    companion object {
        fun newInstance(): jadwal_search {
            return jadwal_search()
        }
    }

    fun loaddatasearch() { RequestAsyncJadwalSearch().execute() }

    inner class RequestAsyncJadwalSearch: AsyncTask<String?, String?, String?>() {

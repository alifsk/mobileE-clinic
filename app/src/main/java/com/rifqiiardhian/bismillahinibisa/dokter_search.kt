...
class dokter_search : Fragment() {

    var view1: View? = null
    var keyword_dokter: String? = null
    ...
    override fun onCreateView(
        ...
        view1 = inflater.inflate(R.layout.fragment_dokter_search, container, false)
        ...
        keyword_dokter = b!!.getString("keyworddokter")

        loaddatadoktersearch()

        return view1
    }

    companion object {
        fun newInstance(): dokter_search {
            return dokter_search()
        }
    }

    fun loaddatadoktersearch() { RequestAsnycDokterSearch().execute() }

    inner class RequestAsnycDokterSearch : AsyncTask<String?, String?, String?>(),
        ...
        override fun doInBackground(vararg strings: String?): String? {
            return try {
                ...
                postDataParams.put("keyword", keyword_dokter)
                postDataParams.put("method", "SearchDokter")

...
class riwayatantrian : Fragment() {
    ...
    override fun onCreateView(
        ...
        view1 = inflater.inflate(R.layout.fragment_riwayatantrian, container, false)
        ...
        daftar_antrian = view1!!.findViewById(R.id.daftar_antrian_riwayat)

        loaddatariwayatantrian()
    ...
    companion object {
        fun newInstance(): riwayatantrian {
            return riwayatantrian()
        }
    }

    fun loaddatariwayatantrian() { RequestAsnycRiwayatAntrian().execute() }

    inner class RequestAsnycRiwayatAntrian : AsyncTask<String?, String?, String?>() {
        ...
        override fun doInBackground(vararg strings: String?): String? {
            return try {
                ...
                postDataParams.put("method", "RiwayatAntrian")

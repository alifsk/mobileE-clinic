...
class obat_search : Fragment() {

    var view1: View? = null
    var keyword_obat: String? = null
    ...
    override fun onCreateView(
        ...
        view1 = inflater.inflate(R.layout.fragment_obat_search, container, false)

        val b = this.arguments
        keyword_obat = b!!.getString("keywordobat")
    ...
    companion object {
        fun newInstance(): obat_search {
            return obat_search()
        }
    }

    fun loaddatasearchobat() { RequestAsnycObatSearch().execute() }

    inner class RequestAsnycObatSearch : AsyncTask<String?, String?, String?>() {
        ...
        override fun doInBackground(vararg strings: String?): String? {
            return try {
                ...
                postDataParams.put("keyword", keyword_obat)
                postDataParams.put("method", "SearchObat")
